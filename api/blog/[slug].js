// Vercel serverless function for individual blog posts - ES modules format
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error('Individual blog post API error:', error);
    res.status(500).json({ 

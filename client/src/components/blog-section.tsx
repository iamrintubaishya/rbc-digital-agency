              ...
              {posts.map((post) => (
                <Card key={post.id} className="group hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                  ...
                  <CardContent>
                    <Link 
                      href={`/blog/${post.slug}`}
                      className="group/link inline-flex items-center justify-between w-full text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-colors duration-200 py-2"
                    >
